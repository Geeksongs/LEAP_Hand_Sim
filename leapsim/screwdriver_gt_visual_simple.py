#!/usr/bin/env python3
"""
Simple visualization of target pose for screwdriver grasping task
Usage: python screwdriver_gt_visual_simple.py <grasp_file.npy>
"""
...
if len(sys.argv) < 2:
    print("Usage: python screwdriver_gt_visual_simple.py <grasp_file.npy>")
    sys.exit(1)
...
if "screwdriver" in grasp_file.lower() or "driver" in grasp_file.lower():
    OBJECT_TYPE = "043_phillips_screwdriver"
    OBJECT_ASSET = "043_phillips_screwdriver_composite.urdf"
elif "mug" in grasp_file:
    OBJECT_TYPE = "025_mug"
    ...
    # Default to screwdriver if not detected
    OBJECT_TYPE = "043_phillips_screwdriver"
    OBJECT_ASSET = "043_phillips_screwdriver_composite.urdf"
...
def visualize_target_pose():
    ...
    print("\n=== Screwdriver Target Pose Visualization ===")
