...
class LeapHandRot(VecTaskRot):
    ...
    def reward_object_position_reward(self):
        ...
        target_pos = to_torch(self.cfg["env"]["target_object_pos"], device=self.device).float()
    ...
    def reward_object_orientation_reward(self):
        ...
        target_quat = to_torch(self.cfg["env"]["target_object_quat"], device=self.device).float()
    ...
    def reward_hand_dof_reward(self):
        ...
        target_dof = to_torch(self.cfg["env"]["target_hand_dof"], device=self.device).float()
